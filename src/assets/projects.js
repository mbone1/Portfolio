const projects = [
  ...
  },
  {
    ...
    description:
      "Straightforward and slim budget app, allows users to enter deposits and withdrawals with a running total. A fully progressive app that works both on and offline.",
