...
import caravaggio from './laptopcaravaggio.glb'

const projects = [
  {
    key: "1",
    name: "Caravaggio",
    url: "https://github.com/mbone1/caravaggio",
    deployedUrl: "https://caravaggio.netlify.app/",
    technologies:
      "React.js, Three.js, React-Three-Fiber, Three-Drei, React-Spring",
    description:
      "Virtual art gallery of Caravaggio paintings, built on React in Three.js with help from Fiber and Drei, animated with React-Spring",
    model: caravaggio,
  },
  {
    key: "2",
  ...
  },
  {
    ...
    description: "Employee Database with various filtering capabilities",
  ...
  },
  {
    ...
    description: "PWA Budget Application",
  ...
  },
  {
    ...
    description:
      "Looking for a way to keep track of the burritos you've eaten? Look no further!",
